...
// Make this "status: (typeof orderTable.$inferSelect)["status"];" will allow me to make comparisons because it will have predefined types. It's a benefit of using TypeScript.
